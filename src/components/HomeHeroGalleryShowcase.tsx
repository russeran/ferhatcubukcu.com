...
export function HomeHeroGalleryShowcase({
  ...
  return (
    <div
      className="relative aspect-[4/3] w-full animate-fade-up overflow-hidden rounded-lg bg-parchment-dark shadow-[0_28px_90px_-28px_rgba(60,20,25,0.45)] ring-1 ring-umber/15 md:aspect-[5/4]"
