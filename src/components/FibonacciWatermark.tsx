...
export function FibonacciWatermark() {
  return (
    ...
    >
      <svg
        className="absolute -right-[18%] top-[8%] h-[min(92vh,820px)] w-[min(92vw,820px)] -translate-y-1/4 translate-x-1/4 text-goldleaf/[0.055] motion-reduce:opacity-0 sm:-right-[12%] sm:top-[12%]"
        viewBox="0 0 100 100"
        fill="none"
      >
        <path
